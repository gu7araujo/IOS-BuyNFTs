...
//  buyNFTs-DEV
//
//  Created by Gustavo Araujo Santos on 11/10/22.
//
...
public enum Typography: RawRepresentable {
    ...
    public static func registerFontFamily() {
        UIFont.registerFont(bundle: .main, fontName: UIFont.stringName(weight: .Light), fontExtension: "ttf")
        UIFont.registerFont(bundle: .main, fontName: UIFont.stringName(weight: .Regular), fontExtension: "ttf")
        UIFont.registerFont(bundle: .main, fontName: UIFont.stringName(weight: .Bold), fontExtension: "ttf")
    }
