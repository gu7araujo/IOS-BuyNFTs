...
class LoginViewController: UIViewController {
    ...
    lazy var loginField: UITextField = {
        ...
        field.placeholder = NSLocalizedString("LoginViewController.login", bundle: .init(for: LoginViewController.self), comment: "")
    ...
    lazy var passwordField: UITextField = {
        ...
        field.translatesAutoresizingMaskIntoConstraints = false
        field.font = .systemFont(ofSize: 20)
        field.placeholder = NSLocalizedString("LoginViewController.password", bundle: .init(for: LoginViewController.self), comment: "")
        field.borderStyle = .roundedRect
    ...
    lazy var loginButton: UIButton = {
        ...
        button.setTitle(NSLocalizedString("LoginViewController.loginButton", bundle: .init(for: LoginViewController.self), comment: ""), for: .normal)
